...
mongoimport --db university --collection Department_info --type csv --file "C:\\Users\\GreyHat\\OneDrive\\degreey3t1\\advance database\\asmt dataset\\university\\Department_Information.csv" --headerline

mongoimport --db university --collection Employee_info --type csv --file "C:\\Users\\GreyHat\\OneDrive\\degreey3t1\\advance database\\asmt dataset\\university\\Employee_Information.csv" --headerline

mongoimport --db university --collection Student_counseling --type csv --file "C:\\Users\\GreyHat\\OneDrive\\degreey3t1\\advance database\\asmt dataset\\university\\Student_Counselling_Information.csv" --headerline

mongoimport --db university --collection Student_performance --type csv --file "C:\\Users\\GreyHat\\OneDrive\\degreey3t1\\advance database\\asmt dataset\\university\\Student_Performance_Data.csv" --headerline
...
--add sharding to collections for scalability--
--Enable sharding on the university database--
sh.enableSharding("university")

--Shard Student_performance collection using Student_ID as shard key--
sh.shardCollection("university.Student_performance", { Student_ID: 1 })

--Shard Student_counseling collection using Student_ID as shard key--
sh.shardCollection("university.Student_counseling", { Student_ID: 1 })

--Shard Employee_info collection using Employee_ID as shard key--
sh.shardCollection("university.Employee_info", { Employee_ID: 1 })

--Shard Department_info collection using Department_ID as shard key--
sh.shardCollection("university.Department_info", { Department_ID: 1 })

--configure replication for high availability--
--Assuming the replica set is already initialized--
rs.initiate({
    _id: "universityReplicaSet",
    members: [
